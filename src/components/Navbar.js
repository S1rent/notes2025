        ...
        <Link className="navbar-brand fw-bold fs-4" to="/">
          <h1
            style={{
              ...
              backgroundImage:
                `linear-gradient(147deg, #923cb5 0%, ${isDarkTheme ? "white" : "#000000"} 74%)`,
        ...
        >
          <ul className="navbar-nav gap-2" style={{ alignItems: "center" }}>
            <li
              ...
              onClick={() => {
                const currentTheme = getTheme()
                const result = changeTheme(currentTheme === THEME_ENUM.dark ? THEME_ENUM.light : THEME_ENUM.dark)
                if(result) {
                  setIsOpen(true);
                }
              }}
            >
              {
                isDarkTheme ? <MoonIcon width={24} height={24} /> : <SunIcon width={32} height={32} />
              }
            </li>
            <li
              className="nav-item"
              ...
              onClick={() => {
                ...
                const result = changeLanguage(currentLang === LANGUAGE_ENUM.english ? LANGUAGE_ENUM.indonesia : LANGUAGE_ENUM.english)
                if(result) {
            ...
            >
              {
                isDarkTheme ? <WhiteLanguageIcon  width={32} height={32} /> : <LanguageIcon width={32} height={32} />
              }
            </li>
